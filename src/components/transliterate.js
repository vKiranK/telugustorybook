// The transliteration library comes from the Sanscript.js Github repository
function Sanscript() {
    "use strict";
    var Sansript = {};
    ...
    // this final section of code is borrowed from Amarahasa which in turn borrowed it from the npm version of sanscript
